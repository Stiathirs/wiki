...
document.body.innerHTML = document.body.innerHTML.replace(/^(?:# )(.*)/gm,'<h3>$1</h3>');
document.body.innerHTML = document.body.innerHTML.replace(/^(?:## )(.*)/gm,'<h4>$1</h4>');
document.body.innerHTML = document.body.innerHTML.replace(/^(?:### )(.*)/gm,'<h5>$1</h5>');
document.body.innerHTML = document.body.innerHTML.replace(/^(?:#### )(.*)/gm,'<h6>$1</h6>');
